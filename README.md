...
**SkillSwap** is a full-stack peer-to-peer skill barter marketplace where users trade expertise using time-credits instead of money. Built with the tech stack mentioned with PostgreSQL/PostGIS for real-time geospatial discovery, it lets users offer or request skills, find nearby matches on an interactive map, and safely exchange time-credits through atomic database transactions.

🔗 **Live demo:** [skill-swap-virid-tau.vercel.app](https://skill-swap-virid-tau.vercel.app)
📦 **Repo:** [github.com/saachijo14/skill-barter](https://github.com/saachijo14/skill-barter)
